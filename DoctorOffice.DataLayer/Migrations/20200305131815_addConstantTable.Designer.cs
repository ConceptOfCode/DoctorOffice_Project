...
namespace DoctorOffice.DataLayer.Migrations
{
    ...
    [Migration("20200305131815_addConstantTable")]
    partial class addConstantTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoctorOffice.Domains.costantConcepts", b =>
                {
                    b.Property<int>("costantConceptsID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("costantConceptsID1")
                        .HasColumnType("int");
                    ...
                    b.HasKey("costantConceptsID");

                    b.HasIndex("costantConceptsID1");

                    b.ToTable("costantConcepts");
                });
            ...
            modelBuilder.Entity("DoctorOffice.Domains.costantConcepts", b =>
                {
                    b.HasOne("DoctorOffice.Domains.costantConcepts", null)
                        .WithMany("CostantConcepts")
                        .HasForeignKey("costantConceptsID1");
                });
