...
namespace DoctorOffice.DataLayer.Migrations
{
    ...
    [Migration("20200306104048_addServiceTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoctorOffice.Domains.Services", b =>
                {
                    ...
                    b.Property<string>("fullTextServices")
                        .IsRequired()
            ...
            modelBuilder.Entity("DoctorOffice.Domains.constantConcepts", b =>
                {
                    b.Property<int>("constantConceptsID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("constantConceptsID1")
                        .HasColumnType("int");
                    ...
                    b.HasKey("constantConceptsID");

                    b.HasIndex("constantConceptsID1");

                    b.ToTable("constantConcepts");
                });
            ...
            modelBuilder.Entity("DoctorOffice.Domains.constantConcepts", b =>
                {
                    b.HasOne("DoctorOffice.Domains.constantConcepts", null)
                        .WithMany("ConstantConcepts")
                        .HasForeignKey("constantConceptsID1");
                });
